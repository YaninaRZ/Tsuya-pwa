...
export default function HabitEdit() {
    ...
    useEffect(() => {
        const load = async () => {
            ...
            if (data) setForm({
                ...
                notes: data.notes || '',
                reminder_days: data.reminder_days || ['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'],
            })
            setLoading(false)
        }
        load()
    ...
    return (
        <div className="min-h-screen flex flex-col" style={{ background: '#0A0A0A' }}>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            >
                                <div
                                    ...
                                    style={{
                                        background: '#fff',
                                        left: form.reminder_enabled ? '26px' : '2px',
                                    }}
                                />
                            </button>
                        </div>
            ...
            {/* Sticky footer */}
            <div
                className="relative z-10 sticky bottom-0 px-6 py-4 flex flex-col gap-3 max-w-lg mx-auto w-full"
                style={{
            ...
            >
                ...
                <button
                    ...
                    className="w-full py-4 rounded-2xl text-xs font-medium"
                    style={{
